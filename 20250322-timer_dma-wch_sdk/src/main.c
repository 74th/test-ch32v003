...
void init(void)
{
    ...
    DMA_InitStructure.DMA_BufferSize = sizeof(gpio_dma_buf) / sizeof(gpio_dma_buf[0]);
    ...
    DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t)gpio_dma_buf;
